...
let QuickOpenContainer = class QuickOpenContainer {
    ...
    clickOnContainerItem(itemText, timeout = TestConstants_1.TestConstants.TS_SELENIUM_DEFAULT_TIMEOUT) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const quickContainerItemLocator = selenium_webdriver_1.By.css(`div[aria-label="${itemText}, picker"]`);
    ...
    invokeByHotKey(timeout = TestConstants_1.TestConstants.TS_SELENIUM_DEFAULT_TIMEOUT) {
        return __awaiter(this, void 0, void 0, function* () {
            Logger_1.Logger.debug('QuickOpenContainer.invokeByHotKey');
            yield this.driverHelper.getDriver().actions().sendKeys(selenium_webdriver_1.Key.F1).perform();
            yield this.waitContainer(timeout);
        });
    }
    typeAndSelectSuggestion(text, suggestedText) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.driverHelper.type(selenium_webdriver_1.By.css('div.monaco-inputbox  input.input'), text);
            yield this.clickOnContainerItem(suggestedText);
        });
    }
};
