...
const WarningDialog_1 = require("../pageobjects/ide/WarningDialog");
...
const CheGitApi_1 = require("../utils/VCS/CheGitApi");
const GitHubUtils_1 = require("../utils/VCS/github/GitHubUtils");
...
function getContainer() {
    ...
    e2eContainer.bind(inversify_types_1.CLASSES.WarningDialog).to(WarningDialog_1.WarningDialog).inSingletonScope();
    ...
    e2eContainer.bind(inversify_types_1.CLASSES.GitHubUtils).to(GitHubUtils_1.GitHubUtils).inSingletonScope();
    e2eContainer.bind(inversify_types_1.CLASSES.KeyCloakUtils).to(KeyCloakUtils_1.KeyCloakUtils).inSingletonScope();
    e2eContainer.bind(inversify_types_1.CLASSES.CheGitApi).to(CheGitApi_1.CheGitApi).inSingletonScope();
    return e2eContainer;
}
